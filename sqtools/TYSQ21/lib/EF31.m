...
if choice == 1
    ...
    y=(gE1d02.*d2 + gE1d22.*d1.^2.*d2 + gE1d42.*d1.^4.*d2 +  ... 
    d1.*((gE1d11 + gE1d12.*d2 + gE1d13.*d2.^2)) +  ... 
    d1.^3.*((gE1d31 + gE1d32.*d2 + gE1d33.*d2.^2))) ; 

    %y= gE1d11.*d1 +  ... 
    %  gE1d31.*d1.^3 + gE1d02.*d2+ gE1d12.*d1.*d2+  ... 
    %  gE1d22.*d1.^2.*d2 + gE1d32.*d1.^3.*d2 +  ... 
    %  gE1d42.*d1.^4.*d2 + gE1d13.*d1.*d2.^2 +  ... 
    %   gE1d33.*d1.^3.*d2.^2;
end

if choice == 2
    y=gE2d20.*d1 + gE2d11.*d2 + gE2d21.*d1.*d2 +  ... 
      gE2d31.*d1.^2.*d2 +  ... 
      gE2d22.*d1.*d2.^2 +  ... 
      gE2d13.*d2.^3 +  ... 
      gE2d23.*d1.*d2.^3 + gE2d33.*d1.^2.*d2.^3 +  ... 
      gE2d24.*d1.*d2.^4 ;
end
...
if choice == 3
    y1=gE1d11.*d1 +  ... 
      ...
      gE1d42.*d1.^4.*d2 + gE1d13.*d1.*d2.^2 +  ... 
       gE1d33.*d1.^3.*d2.^2;
    y2=gE2d20.*d1 + gE2d11.*d2 + gE2d21.*d1.*d2 +  ... 
      gE2d31.*d1.^2.*d2 +  ... 
      gE2d22.*d1.*d2.^2 +  ... 
      gE2d13.*d2.^3 +  ... 
      gE2d23.*d1.*d2.^3 + gE2d33.*d1.^2.*d2.^3 +  ... 
