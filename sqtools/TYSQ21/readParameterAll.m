function coeArray = readParameterAll(fileName)
...
%    end;
    ...
    line=fgetl(fid);
    coeArray(i).a=readPattern(line);

    line=fgetl(fid);
    coeArray(i).b=readPattern(line);

    line=fgetl(fid);
    coeArray(i).c1=readPattern(line);
    
    line=fgetl(fid);
    coeArray(i).c2=readPattern(line);
 
    line=fgetl(fid);
    coeArray(i).d1=readPattern(line);

    line=fgetl(fid);
    coeArray(i).d2=readPattern(line);
