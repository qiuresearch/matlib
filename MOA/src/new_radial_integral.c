...
#include "string.h"
/*#include "Integrate.c"*/
/*#include "Fake_Integrate.c"*/
#include "New_Integrate.c"
...
void mexFunction(
  ...
  mexPrintf("Inside radial_integral.mex.c, done checking inputs/outputs \n");
  ...
  mexPrintf("Inside radial_integral.mex.c, done with Step 1 \n");
  ...
  mexPrintf("Inside radial_integral.mex.c, done with Step 2 \n");
  ...
  mexPrintf("Inside radial_integral.mex.c, done with Step 3 \n");
    ...
    mexPrintf("Inside radial_integral.mex.c, done with Step 4 \n");
    ...
    mexPrintf("Inside radial_integral.mex.c, done with Step 5 \n");
   ...
   mexPrintf("Inside radial_integral.mex.c, done with Step 6 \n");
   ...
   mexPrintf("Inside radial_integral.mex.c, done with Step 7 \n");  
   ...
   mexPrintf("Inside radial_integral.mex.c, done with Step 8 \n");
	...
	/*  q, Intensity, r_min, r_max, Num_Bins, mode);*/
	working_radial_integral(image,mask,width,height,xcen,ycen,
			q, Intensity, r_min, r_max, Num_Bins, mode);

   mexPrintf("Inside radial_integral.mex.c, done with Step 9 \n");
   mexPrintf("%s", "Inside radial_integral.mex.c, done with Step 9 \n");
