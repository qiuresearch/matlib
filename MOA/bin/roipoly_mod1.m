function varargout = roipoly_mod1(varargin)
% stolen from Matlab's image processing toolkit.
% modified to accept imagesc.
% all hacking is shown as %$$$$$$$$$$$$$$.
...
%   The output image BW is of class uint8. All other inputs and 
...
%   $Revision: 1.1 $  $Date: 2010-02-08 16:59:32 $
...
% $$$$$$$$$$$$$$
% case 1 % taken out to allow us to pass a range of display.
case 3
% $$$$$$$$$$$$$$
    ...
    % $$$$$$$$$$$$
    % imshow(a); removed.
    show(a,range,data_range); 
    % $$$$$$$$$$$$
    
    [xi,yi] = getline(gcf,'closed');
    
% $$$$$$$$$$$$
%  Taken out to avoid confusion with above case.
%case 2
%    % ROIPOLY(M,N)
%    nrows = varargin{1};
%    ncols = varargin{2};
...
% $$$$$$$$$$$$$
% Taken out to avoid confusion with above call.
%case 3,
