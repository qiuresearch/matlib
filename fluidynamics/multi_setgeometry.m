function [fem, geoconst] = multi_setgeometry(varargin)
%
% FEMLAB Model M-file
...
fem.const={'rho','0.99713e3','eta','0.891e-3','concen_buf','2.0', ...
           'concen_sam', '1.0','D','2.045e-9','v_sam','1e-2', ...
           'v_buf','1e-1', 'v_dia', '5e-3', 'concen_avg', ...
           ['(concen_sam*(v_sam+2*v_dia)+concen_buf*v_buf*2)/' ...
            '(v_sam+2*v_dia+2*v_buf)'] };
...
bnd.ind = [3,1,1,3,1,1,2,1,1,1,2,1,1,1,2,4,1,1,1,2,1,1,5];
appl.bnd = bnd;
clear equ
equ.shape = 1;
equ.gporder = 1;
