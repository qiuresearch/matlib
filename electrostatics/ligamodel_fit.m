function [ligaconcen, ligafit] = ligamodel_fit(boundconcen, valence, ...
                                               freeconcen, varargin)
% --- Usage:
...
inonzero = find(ligafit.boundconcen(:,2) > 0);
ligafit.boundconcen = ligafit.boundconcen(inonzero,:);
ligafit.freeconcen  = ligafit.freeconcen(inonzero,:);
inonzero = find(ligafit.freeconcen(:,1) > 0);
ligafit.boundconcen = ligafit.boundconcen(inonzero,:);
ligafit.freeconcen  = ligafit.freeconcen(inonzero,:);
inonzero = find(ligafit.freeconcen(:,2) > 0);
ligafit.boundconcen = ligafit.boundconcen(inonzero,:);
ligafit.freeconcen  = ligafit.freeconcen(inonzero,:);
