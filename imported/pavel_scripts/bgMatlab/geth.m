...
%GETH        mouse-based selection of text or line objects
%  [HSEL, HREST] = GETH('t[ext]') or
%  [HSEL, HREST] = GETH('l[ine]')
%    HSEL  - handles to the selected objects
%    HREST - handles to the objects not selected
%    selection mode is finished by clicking the right mouse button
%  HSEL = GETH('t[ext]', 'all')  get all text objects
%  HSEL = GETH('l[ine]', 1:3)  select last 3 line objects
%  GETH T[EXT] IND  shows indices of text objects and do nothing

%  1997 by Pavol
%  $Id: geth.m 26 2007-02-27 22:45:38Z juhas $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
