...
%  MVTEXT 1    move the last inserted text
%  MVTEXT 1:3  move the last 3 text objects
%  MVTEXT ALL  move all text objects within gca
%  MVTEXT ALL [DX, DY]  or
%  MVTEXT(HT, [DX, DY])  shift specified text objects by [DX, DY]
%  MVTEXT(HT, [X, Y], 'abs')  move text to [X, Y]
%  MVTEXT(HT, [X, DY], 'absx')  move text to [X, Y+DY]
%  MVTEXT(HT, [DX, Y], 'absy')  move text to [X+DX, Y]
%  MVTEXT IND  show indices of the text objects and do nothing

%  $Id: mvtext.m 26 2007-02-27 22:45:38Z juhas $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
