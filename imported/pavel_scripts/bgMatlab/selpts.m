...
%  I = SELPTS(HLINE)  where HLINE is a handle to line object
%  I = SELPTS   first it is necessary to select line with the mouse,
%    then click the right button to proceed

%  $Id: selpts.m 26 2007-02-27 22:45:38Z juhas $
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
