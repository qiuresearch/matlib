...
hPopupmenu5a = uicontrol(...
    ...
    'String','contour (default)|filled contour|mesh plot|surface plot',...
...
hPushbuttonOK = uicontrol(...
    ...
    'callback',{@specrsettings_OKRequestFcn,hFigSpecr,h,hEdit1,hEdit2,hPopupmenu3a,hPopupmenu3b,hEdit4a,hPopupmenu4b,hPopupmenu5a,hPopupmenu5b});
...
% --- specrsettings close function
%================================================================
function specrsettings_OKRequestFcn(hObject,eventdata,hFigSpecr,h,hEdit1,hEdit2,hPopupmenu3a,hPopupmenu3b,hEdit4a,hPopupmenu4b,hPopupmenu5a,hPopupmenu5b)
settings = getappdata(hFigSpecr,'settings');
...
settings.meshScanExport2WS = get(hPopupmenu5b,'value');
