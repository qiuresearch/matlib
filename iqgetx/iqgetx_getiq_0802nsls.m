function [iq, sIqgetx] = iqgetx_getiq_0802nsls(sIqgetx, startnum, skipnums, sOpt)
% --- Usage:
...
% --- Example(s):
%
% $Id: iqgetx_getiq_0802nsls.m,v 1.4 2013/08/23 18:52:47 xqiu Exp $
%

verbose = 1;
% 1) Simple check on input parameters
if nargin < 1
   help iqgetx_getiq_0802nsls
   return
end
