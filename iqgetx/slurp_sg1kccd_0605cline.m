function [sumdata, imgdata] = slurp_sg1kccd_0605cline(prefix, imgnums, darknums, sOpt)
% --- Usage:
...
% --- Example(s):
%
% $Id: slurp_sg1kccd_0605cline.m,v 1.3 2013/08/19 03:02:26 xqiu Exp $
%
...
for i=1:num_imgs
   ...
   imgdata(i).monnames = {'xflash', 'i1', 'i0', 'i2'};
...
% --- Change History:
%
% $Log: slurp_sg1kccd_0605cline.m,v $
