function [sumdata, imgdata] = slurp_marccd_0806nsls(prefix, imgnums, darknums, sOpt)
% --- Usage:
...
% --- Example(s):
%
% $Id: slurp_marccd_0806nsls.m,v 1.5 2013/08/19 03:02:26 xqiu Exp $
%
global MaskI
...
for i=1:num_imgs
   ...
   imgdata(i).monnames = {'transbeam', 'bicron', 'IC', 'mean'};
   ...
   % assign the moncounts
   imgdata(i).moncounts = [transbeam, bicron,1,imgdata(i).mean];
   if (sOpt.normalize ~= 0)
